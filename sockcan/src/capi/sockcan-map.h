...
enum can_ISOTP {
    x_SOL_ISOTP = SOL_CAN_ISOTP,
    x_OPTS = CAN_ISOTP_OPTS,
    x_RECV_FC = CAN_ISOTP_RECV_FC,
    x_TX_STMIN = CAN_ISOTP_TX_STMIN,
    x_RX_STMIN = CAN_ISOTP_RX_STMIN,
    x_LL_OPTS = CAN_ISOTP_LL_OPTS,
    x_LISTEN_MODE = CAN_ISOTP_LISTEN_MODE,
    x_EXTEND_ADDR = CAN_ISOTP_EXTEND_ADDR,
    x_TX_PADDING = CAN_ISOTP_TX_PADDING,
    x_RX_PADDING = CAN_ISOTP_RX_PADDING,
    x_CHK_PAD_LEN = CAN_ISOTP_CHK_PAD_LEN,
    x_CHK_PAD_DATA = CAN_ISOTP_CHK_PAD_DATA,
    x_HALF_DUPLEX = CAN_ISOTP_HALF_DUPLEX,
    x_FORCE_TXSTMIN = CAN_ISOTP_FORCE_TXSTMIN,
    x_FORCE_RXSTMIN = CAN_ISOTP_FORCE_RXSTMIN,
    x_RX_EXT_ADDR = CAN_ISOTP_RX_EXT_ADDR,
    x_WAIT_TX_DONE = CAN_ISOTP_WAIT_TX_DONE,
    x_SF_BROADCAST = CAN_ISOTP_SF_BROADCAST,
    x_DEFAULT_FLAGS = CAN_ISOTP_DEFAULT_FLAGS,
    x_DEFAULT_EXT_ADDRESS = CAN_ISOTP_DEFAULT_EXT_ADDRESS,
    x_DEFAULT_PAD_CONTENT = CAN_ISOTP_DEFAULT_PAD_CONTENT,
    x_DEFAULT_FRAME_TXTIME = CAN_ISOTP_DEFAULT_FRAME_TXTIME,
    x_DEFAULT_RECV_BS = CAN_ISOTP_DEFAULT_RECV_BS,
    x_DEFAULT_RECV_STMIN = CAN_ISOTP_DEFAULT_RECV_STMIN,
    x_DEFAULT_RECV_WFTMAX = CAN_ISOTP_DEFAULT_RECV_WFTMAX,
    x_DEFAULT_LL_MTU = CAN_ISOTP_DEFAULT_LL_MTU,
    x_DEFAULT_LL_TX_DL = CAN_ISOTP_DEFAULT_LL_TX_DL,
    x_DEFAULT_LL_TX_FLAGS = CAN_ISOTP_DEFAULT_LL_TX_FLAGS,
};
...
enum can_J1939 {
    ...
    x_SO_FILTER= SO_J1939_FILTER,
    x_SO_PROMISC=SO_J1939_PROMISC,
    x_SO_SEND_PRIO=SO_J1939_SEND_PRIO,
    x_SO_ERRQUEUE=SO_J1939_ERRQUEUE,
    x_MAX_TP_PACKET_SIZE= (7 * 0xff),
    x_MAX_ETP_PACKET_SIZE= (7 * 0x00ffffff),
    x_SCM_DEST_ADDR=SCM_J1939_DEST_ADDR,
    x_SCM_DEST_NAME=SCM_J1939_DEST_NAME,
    x_SCM_PRIO=SCM_J1939_PRIO,
